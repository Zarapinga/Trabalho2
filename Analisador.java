...
public class Analisador {
    ...
    public String getSaberNomePlaneta() {
        ...
        JogoInterface.getRelatorio("voce tem certeza de que quer saber o nome do planeta atual? isso vai custar 3/4 do seu combustivel? ");
        return in.nextLine();
    ...
    public Comando pegarComando() {
        ...
        linha = JogoInterface.processarAcao();
