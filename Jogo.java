...
public class Jogo {
    ...
    public Jogo() {
        ...
        nave = new Nave();
        log = "";
        interfaceJ = new JogoInterface(jogador, nave);
        acao = new AcoesJogador(interfaceJ);
    ...
    public void jogar() {
        ...
        interfaceJ.exibir();
        JogoInterface.getRelatorio(imprimirBoasVindas());

        while (!terminado) {

            JogoInterface.getRelatorio(imprimirEstado());
            Comando comando = analisador.pegarComando();
            terminado = processarComando(comando);

        }

        JogoInterface.getRelatorio("Obrigado por jogar. Ate mais!");
    ...
    private boolean processarComando(Comando comando) {
        ...
        if (comando == null) {
            ...
            JogoInterface.getRelatorio("Comando invalido!");
            return false;

        }

        String palavraGatilho = comando.getGatilho();
        JogoInterface.getRelatorio("palavra de comando: " + palavraGatilho);
        ...
        switch (palavraGatilho) {
            ...
            case "ajuda":
                ...
                JogoInterface.getRelatorio(imprimirAjuda());
                break;
            ...
            case "dica":
                ...
                JogoInterface.getRelatorio(getDica());
                break;
    ...
    public String imprimirBoasVindas() {
        ...
        String boasVindas = pegarMensagemInicial();
        escreverLog(pegarMensagemInicial());
        System.out.println();
        boasVindas += "planeta atual: " + jogador.getPlanetaAtual().getDescricao();
