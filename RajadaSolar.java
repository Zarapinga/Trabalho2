...
public class RajadaSolar implements Desafio {
    ...
    public void imprimirDescricaoEvento() {
        ...
        JogoInterface.getRelatorio("Durante sua viagem, uma rajada solar gerou uma pane eletrica no sistema de navegacao da sua nave, e voce foi direcionado para um planeta aleatorio...");
