...
public class Inventario {
    ...
    public void listarItens() {
        JogoInterface.getRelatorio("Listando itens no inventario: ");
        for (Map.Entry<Item, Integer> entrada : listaInventario.entrySet()) {
            Item objeto = entrada.getKey();
            JogoInterface.getRelatorio(objeto.getNome() + " " + entrada.getValue());           
        }
        JogoInterface.getRelatorio("Todos os itens listados.");
    }
